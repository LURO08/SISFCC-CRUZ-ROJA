...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <main>
            ...
            <div>
                <a href="{{route('socorros.index')}}" class="btn btn-primary bg-pink-600"
                style="width: 50%; margin: 0 auto; margin-bottom: 0px;">Regresar</a>
                        ...
                        <div style=" margin-top: 30px; margin: 0 auto;">
                            ...
                            <div class="phase bg-white p-6 rounded-lg shadow-md" id="phase1">
                                <div class="max-h-[55vh] overflow-y-auto">
                                    ...
                                    <div class="mb-6">
                                        <h6 class="text-lg font-semibold text-gray-700 mb-2">Detalles del Servicio</h6>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div class="form-group">
                                                <label for="direccion_accidente"
                                                    class="form-label text-sm font-medium text-gray-600">Ubicación del
                                                    Servicio</label>
                                ...
                                <div class="flex justify-center space-x-4 mt-6">
                                    <button type="button"
                                        class="px-4 py-2 bg-blue-500 text-white font-medium rounded-lg shadow-md hover:bg-blue-600 transition"
                            ...
                            <div class="phase" id="phase4" style="display:none;">
                                <div style="max-height: 60vh; overflow-y: auto; display: flex;">
                                    ...
                                    <div style="padding: 10px;">
                                        ...
                                        <div id="accidente_automovilistico_3" style="display: none;">
                            ...
                            <div class="phase" id="phase6" style="display: none;">
                                <div style="max-height: 60vh; overflow-y: auto;">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="cesareas" id="cesareas" class="form-control"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="membranas" id="membranas" class="form-control"
                                            placeholder="Estado de las membranas">
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="duracion" id="duracion" class="form-control"
                                            placeholder="Duración de contracciones">
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="placenta_expulsada" class="form-label">placenta_expulsada</label>
                                ...
                                <div style="max-height: 60vh; overflow-y: auto;">
                                    ...
                                    <div class="form-group">
                                        <label for="nivel_conciencia" class="form-label">Nivel de
                                            Conciencia</label>
                                        <select id="nivel_conciencia" name="nivel_conciencia" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label for="ventilacion_observacion" class="form-label">Observación</label>
                                    ...
                                    <div class="form-group">
                                        <label for="ventilacion_auscultacion" class="form-label">Auscultación</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="ventilacion_sitio" name="ventilacion_sitio" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="circulacion_piel" name="circulacion_piel" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="circulacion_caracteristicas" name="circulacion_caracteristicas"
                                            class="form-control">
                            ...
                            <div class="phase" id="phase8" style="display:none;">/
                                <div style="max-height: 60vh; overflow-y: auto;">
                                    ...
                                    <div>
                                        ...
                                        <div class="section-content" style="display: none;">
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th style="border-bottom: 2px solid #000; padding: 10px;">
                                                            Imagen</th>
                                                        <th style="border-bottom: 2px solid #000; padding: 10px;">
                                                            Seleccionar</th>
                                                    </tr>
                                    ...
                                    <div>
                                        ...
                                        <div class="section-content" style="display: none; padding-top: 8px;">
                            ...
                            <div class="phase" id="phase9" style="display:none;">
                                <div style="max-height: 60vh; max-width: 80vh; overflow-y: auto;">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-col space-y-2">
                                            <label>
                                                <input type="radio" name="control_cervical" value="manual">
                                                Manual
                                            </label>
                                            <label>
