...
<body>
    ...
    <div class="central">
        ...
        <section id="Panelfarmacia" style="width: 100%;">
            <div style="width: 100%;">
                ...
                <div style="display: flex; flex-direction: row; justify-content: center; align-items: center; padding:10px 10px; background-color: #f8f9fa; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    <h1 style="font-weight: bold; font-size: 28px; color: #007bff; text-align: center; margin-bottom: 5px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.2);">
                        Editar Receta
                    </h1>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
                    ...
                    <div class="search-container" style="flex: 1; margin-right: 5px;">
                        <div style="display: flex;  align-items: center;">
                            ...
                            <input type="search" id="searchPatient" placeholder="Buscar paciente por nombre..." value="{{$recetas->nombre_paciente}}" disabled
                ...
                <form action="{{ route('doctor.receta.update',$recetas->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div style="flex: 1; margin-right: 20px;">
                            ...
                            <div>
                                <label for="diagnostico"
                                    ...
                                    <textarea id="diagnostico" name="diagnostico" rows="2" required placeholder="Escribe el diagnóstico aquí..."
                                    style="width: 100%; padding: 0.5rem; border-radius: 4px; border: 1px solid #ccc; resize: vertical;">{{$recetas->diagnostico}}</textarea>
                            </div>

                            {{-- CONTENEDORES DE TRATAMIENTO Y MATERIAL --}}
                            <div>
                                {{-- CONTENEDOR DE MEDICAMENTOS AGREGADOS --}}
                                ...
                                {{-- CONTENEDOR DE MATERIAL AGREGADO --}}
                                    <div id="listaMaterial" style="display: none;">
                                        <h5 style="font-weight: 700; ">Material Utilizado:</h5>
                        ...
                        <div style="flex: 1; width: 100%;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            <input type="text" id="presion_arterial" name="presion_arterial"
                                                placeholder="120/80" value="{{$recetas->presion_arterial}}"
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            <input type="number" id="temperatura" name="temperatura"
                                                placeholder="36.6" value="{{$recetas->temperatura}}"
                                                style="flex: 1; padding: 0.5rem; border-radius: 4px; border: 1px solid #ccc";
                                                step="0.1" min="0">
                                ...
                                <div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            <input type="number" id="frecuencia_cardiaca" name="frecuencia_cardiaca"
                                                min="0" placeholder="75" value="{{$recetas->frecuencia_cardiaca}}"
                                                style="flex: 1; padding: 0.5rem; border-radius: 4px; border: 1px solid #ccc;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            <input type="number" id="frecuencia_respiratoria"
                                                name="frecuencia_respiratoria" placeholder="20" min="0" value="{{$recetas->frecuencia_respiratoria}}"
                                                style="flex: 1; padding: 0.5rem; border-radius: 4px; border: 1px solid #ccc;">
                                            <p style="margin-left: 0.5rem;">X'</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            <input type="number" id="saturacion_oxigeno" name="saturacion_oxigeno"
                                                placeholder="98" min="0" value="{{$recetas->saturacion_oxigeno}}"
                                                style="flex: 1; padding: 0.5rem; border-radius: 4px; border: 1px solid #ccc;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 1rem; flex-basis: 100%;">
                                        ...
                                        <input type="text" id="alergia" name="alergia"
                                            placeholder="Especificar alergias" value="{{$recetas->alergia}}"
                            ...
                            <div>
                                <div class="form-group"
                                    ...
                                    {{ $transaccion->destino === 'farmacia' ? 'checked' : '' }}
                                    @endforeach
                    ...
                    <div class="modal-footer" style="margin: 0; padding: 0; margin-top: 0px;">
    ...
    <script>
        ...
        window.addEventListener('load', cargarMaterial);
        ...
        function cargarMedicamentos() {
            const tratamientoTexto = `{{ $recetas->tratamiento }}`.trim();
            const lineas = tratamientoTexto.split('\n');

            // Recorrer cada línea y parsearla
            lineas.forEach((linea, index) => {
                // Validar si la línea tiene el formato esperado
                    const match = linea.match(/^(.*?)- Durante: (\d+) días?, Cada: (\d+) horas?$/);
                    // Crear el objeto tratamiento con los valores parseados
                    const tratamiento = {
                        id: `${index}`, // Generar un ID automático basado en el índice
                        nombre: match[1].trim(),
                        durante: parseInt(match[2], 10),
                        cada: parseInt(match[3], 10)
                    };
        ...
        function eliminarTratamiento(index) {
         ...
         function cargarMaterial() {
            const MaterialTexto = `{{ $recetas->material }}`.trim();
            const lineas = MaterialTexto.split('\n');

            // Recorrer cada línea y parsearla
            lineas.forEach((linea, index) => {
                // Validar si la línea tiene el formato esperado
                    const match = linea.match(/^(.*?)- Cantidad: (\d+) ?$/);
                    // Crear el objeto tratamiento con los valores parseados
