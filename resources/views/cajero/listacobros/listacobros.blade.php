<style>
    ...
    .cobroNuevoServicio .modal-content {
        max-width: 500px;
    }

    .cobroNuevoServicio .ServiciosPaneles {
        height: 60vh;
        overflow: auto;
    }
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="solicitarFacturaLabel">Solicitud de
                                                Factura de {{ $cobro->paciente->nombre ?? 'Sin Asignar' }}</h5>
...
<script>
    ...
    // Detecta cuando el usuario hace clic fuera del buscador
