        ...
        <form action="{{ route('cajero.cobro.store') }}" method="POST">
            ...
            <div class="card">
                    ...
                    <div style="display: flex; width: 100%; justify-content: center;">
                        <div style="width: 50%;">
                            ...
                            <div class="form-group mb-4">
                                <label for="searchPatient" style="font-weight: bold;">Seleccione o Ingrese el Paciente:</label>
                                <input
                                    type="search"
                                    id="searchPatient"
                                    name="pacienteNombre"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="edad" id="edad" placeholder="Ingrese la edad del Paciente" class="form-control">
                            </div>
                        </div>
                    ...
                    <div  style="display: flex; justify-content: center; width: 100%;">
                        <div style="width: 50%; justify-content: center;">
                            <div style="display: flex; width: 100%; justify-content: center; align-items: center;">
                                ...
                                <a href="#materialModal" class="btn btn-secondary" style="margin-left: 10px; padding: 10px 20px; text-decoration: none; color: white; background-color: #6c757d; border-radius: 5px; text-align: center;" data-bs-toggle="modal">
                                    Agregar Servicio
                                </a>
                            </div>
                        ...
                        <div style="width: 50%; justify-content: center;">
                            ...
                            <div style="width: 100%;">
                                <div style="display: flex; width: 100%; justify-content: center; align-items: center;">
                                    ...
                                    <a href="#medicamentoModal" class="btn btn-primary" style="margin-left: 10px; padding: 10px 20px; text-decoration: none; color: white; background-color: #007bff; border-radius: 5px; text-align: center;" data-bs-toggle="modal">
                                        Agregar Medicamento
                                    </a>
                                </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal" onclick="closeModalServicios()">X</button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group" style=" justify-content: space-between;">
                                        ...
                                        <input type="search" id="searchServicio"
                                            placeholder="Busca servicio por nombre..."
                                            oninput="searchServicios()">
                                    ...
                                    <div class="form-group" id="CampoServicio" style="display: none;">
                                        ...
                                        <input type="text" id="selectedServicio" name="selectedServicio"
                                            readonly>
                                        <input type="hidden" id="selectedServicioId"
                                            name="selectedServicioId">
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal" onclick="closeModalServicios()">Cerrar</button>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="montoTotal" id="montoTotal" class="form-control" value="0.0"
                        readonly>
                </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    function searchPatient() {
        ...
        filteredPacientes.forEach(paciente => {
            ...
            div.onclick = () => selectPatient(paciente.id,  div.textContent,paciente.edad, paciente.sexo, paciente.tipo_sangre);
    ...
    // SERVICIOS
        ...
        function actualizarListaMedicamentos() {
            ...
            tratamientos.forEach((medicamento, index) => {
                ...
                const texto = document.createElement('span');
                texto.textContent = `${medicamento.nombre} - Costo: $${medicamento.costo} - Cantidad: ${medicamento.cantidad}`;
                ...
                inputTratamiento.value += `${medicamento.nombre} - Costo: $${medicamento.costo} - Cantidad: ${medicamento.cantidad}\n`;
                closeModal();
            });
