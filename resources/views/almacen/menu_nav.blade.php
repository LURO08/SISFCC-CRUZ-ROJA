...
<aside id="aside">
    ...
    <ul id="menu" class="collapsed">
        <li>
            <a href="{{ route('almacenista.index', ['category' => 'vehicular']) }}"
               class="btn {{ request('category') == 'vehicular' ? 'active' : '' }}">
                <span class="icon">🚗</span>
                <span class="text" style="font-weight: bold;">Vehicular</span>
            </a>
        </li>
        <li>
            <a href="{{ route('almacenista.index', ['category' => 'medico']) }}"
               class=" btn {{ request('category') == 'medico' ? 'active' : '' }}">
                <span class="icon">💉</span>
                <span class="text" style="font-weight: bold;">Médico</span>
            </a>
        </li>
        <li>
            <a href="{{ route('almacenista.index', ['category' => 'oficina']) }}"
               class=" btn {{ request('category') == 'oficina' ? 'active' : '' }}">
                <span class="icon">📂</span>
                <span class="text" style="font-weight: bold;">Oficina</span>
            </a>
        </li>
        <li>
            <a href="{{ route('almacenista.index', ['category' => 'computo']) }}"
               class=" btn {{ request('category') == 'computo' ? 'active' : '' }}">
                <span class="icon">💻</span>
                <span class="text" style="font-weight: bold;">Cómputo</span>
            </a>
        </li>
        <li>
            <a href="{{ route('almacenista.index', ['category' => 'limpieza']) }}"
               class=" btn {{ request('category') == 'limpieza' ? 'active' : '' }}">
                <span class="icon">🧹</span>
                <span class="text" style="font-weight: bold;">Limpieza</span>
            </a>
        </li>
    </ul>
</aside>
